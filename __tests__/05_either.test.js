...
describe('Either or', () => {
  describe('Left - Structure', () => {
    test('It should be a function', () => {
      shouldBeAFunction(left);
      shouldBeAFunction(right);
    });

    describe('It should implement the following methods',() => {
      test('map', () => {
  ...
  describe('Right - Structure', () => {
    test('It should be a function', () => {
      shouldBeAFunction(right);
    });

    describe('It should have the following methods',() => {
      test('map', () => {
        shouldBeAFunction(right().map);
      });

      test('fold', () => {
        shouldBeAFunction(right().fold);
      });
    });
  });
